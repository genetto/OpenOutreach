...
- **`conf.py:CAMPAIGN_CONFIG`** — Hardcoded timing/ML defaults:
  ...
  - `min_ready_to_connect_prob` (0.99) — GP probability threshold for promoting QUALIFIED profiles to READY_TO_CONNECT
