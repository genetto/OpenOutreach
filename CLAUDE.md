...
- **`conf.py:CAMPAIGN_CONFIG`** — Hardcoded timing/ML defaults:
  ...
  - `min_positive_pool_prob` (0.5) — P(f > 0.5) threshold for positive pool check in exploit mode
